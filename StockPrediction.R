...
{
  #### Hackerrank Editor Read Input - Start
  #stdin <- file('input')
  #open(stdin)
  #input <- readLines(stdin,  warn=FALSE)
  #close(stdin)
  #### Hackerrank Editor Read Input - End
  # Read Input in RStudio - Start
  #setwd("/Users/oindrilasen/WORK_AREA/DataScience/HackerRank/StockPrediction")
  input <- readLines("input2.txt", warn = FALSE)
  # Read Input in RStudio - End
...
#SMA
#(4.54 + 5.53 + 6.56 + 5.54)/4

#wma
#((4.54 * 1) + (5.53 * 2) + (6.56 * 3) + (5.54 * 4))/(4 * (4 +1)/2)
